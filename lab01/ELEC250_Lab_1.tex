...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.4]{Fig_2_1.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=.7]{CurrentLawMeasurement.png}
	%\includegraphics[scale=0.2,width=\linewidth, keepaspectratio]{Fig_2_1.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.65]{VoltageLawMeasurement.png}
	%\includegraphics[scale=0.2,width=\linewidth, keepaspectratio]{Fig_2_1.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=1.25]{CurrentLinearity.png}
	%\includegraphics[scale=0.2,width=\linewidth, keepaspectratio]{Fig_2_1.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.8]{LinearityMeasurement.png}
	%\includegraphics[scale=0.2,width=\linewidth, keepaspectratio]{Fig_2_1.png}
	\caption{Linearity}
